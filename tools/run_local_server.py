...
def parse_args(argv: Optional[list[str]] = None) -> argparse.Namespace:
    ...
    parser.add_argument("--port", type=int, default=0, help="Port to use. Default: bind an available port.")
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    try:
        ...
        server = create_server(ROOT, host, args.port, allow_network=args.allow_network)
